...
Topbar() {
  ...
  return (
    <div>
      <div
        className={
          "flex relative z-50 items-center justify-between  lg:px-10  px-4"
        }
      >
        <div>
        ...
        <div className={"flex items-center gap-5 relative"}>
          <div className={" bg-white "}>
            ...
            >
              ...
              <i
                onClick={conditionChevron}
                className={`fa-solid relative z-[90] p-3 mt-1 ${
                  condition ? "fa-chevron-up" : "fa-chevron-down"
                } `}
              ></i>
            </div>
            ...
            {condition && (
              <div
                ...
                className={
                  "flex gap-2 lg:mt-[-30px] items-center cursor-pointer"
                }
              >
